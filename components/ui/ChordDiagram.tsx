...
const SIZE_MAP = {
  sm: { w: 80, h: 110, dotR: 4, fontHead: 16, fontMark: 9, fontFinger: 7 },
  md: { w: 120, h: 160, dotR: 6, fontHead: 22, fontMark: 12, fontFinger: 10 },
  lg: { w: 180, h: 240, dotR: 9, fontHead: 32, fontMark: 16, fontFinger: 14 },
};
...
export function ChordDiagram({
  ...
  const PAD_TOP = 26; // room for X/O labels
  const PAD_BOTTOM = 28; // room for chord-name caption
  const SIDE = 12;
  const stringCount = 6;
  const fretCount = 4;
